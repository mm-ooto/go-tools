...
// Encrypt 加密
//
//	cryptoType 加密方式,可选值[goaesdes.Aes,goaesdes.Des,goaesdes.TriDes];
//	plainText 待加密数据;
//	iv: IV向量;
//	mode加密模式,可选值[goaesdes.ECB,goaesdes.CBC,goaesdes.CFB,goaesdes.OFB,goaesdes.CTR];
//	padding 填充模式,可选值[goaesdes.No,goaesdes.Zero,goaesdes.Pkcs5,goaesdes.Pkcs7];
